...
const { isValid, isValidName, isValidEmail, isValidPhoneNumber, isValidGender, } = require("../validation/validation")
...
addUser = async (req, res) => {
    try {
        ...
        const { name, email,password, phone, address, age, gender } = data;
        ...
        let dupllicatePhone = await userModel.findOne({ phone })
        ...
        if (!isValidGender(gender)){
          return res.status(400).json({ msg: "give rigth gender from this male,female or other" })
        }
